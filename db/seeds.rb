...
Badge.create(target: 5, name: "Asparagus", description: "Mange 5 repas veggies", picture_path: "badge1.svg")
Badge.create(target: 25, name: "Broccoli", description: "Mange 25 repas veggies", picture_path: "badge2.svg")
Badge.create(target: 100, name: "Mushroom", description: "Mange 100 repas veggies", picture_path: "badge3.svg")
Badge.create(target: 5, name: "Orange", description: "Participe à 5 challenges", picture_path: "badge4.svg")
Badge.create(target: 25, name: "Pineapple", description: "Participe à 25 challenges", picture_path: "badge5.svg")
Badge.create(target: 100, name: "Pomegranate", description: "Participe à 100 challenges", picture_path: "badge6.svg")
Badge.create(target: 5, name: "Radish", description: "Sois en positif 5 jours", picture_path: "badge7.svg")
Badge.create(target: 25, name: "Salad", description: "Sois en positif 25 jours", picture_path: "badge8.svg")
Badge.create(target: 100, name: "Tangerine", description: "Sois en positif 100 jours", picture_path: "badge9.svg")
