...
Badge.create(target: 25, name: "Le badge2", description: "Mange 25 repas veggies", picture_path: "app/assets/images/badge2.svg")
Badge.create(target: 100, name: "Le badge3", description: "Mange 100 repas veggies", picture_path: "app/assets/images/badge3.svg")
Badge.create(target: 5, name: "Le badge4", description: "Participe à 5 challenges", picture_path: "app/assets/images/badge4.svg")
Badge.create(target: 25, name: "Le badge5", description: "Participe à 25 challenges", picture_path: "app/assets/images/badge5.svg")
Badge.create(target: 100, name: "Le badge6", description: "Participe à 100 challenges", picture_path: "app/assets/images/badge6.svg")
Badge.create(target: 5, name: "Le badge7", description: "Sois en positif 5 jours", picture_path: "app/assets/images/badge7.svg")
Badge.create(target: 25, name: "Le badge8", description: "Sois en positif 25 jours", picture_path: "app/assets/images/badge8.svg")
Badge.create(target: 100, name: "Le badge9", description: "Sois en positif 100 jours", picture_path: "app/assets/images/badge9.svg")
